...
function OrderPmoTwo ({ widgetId, data, loading, isMockData }) {
  const [selectedStatus, setSelectedStatus] = useState(null);
  const [modalOpen, setModalOpen] = useState(false);

  console.log(`[OrderPmoTwo] Рендер виджета ${widgetId}, данные:`, data ? 'есть' : 'нет', 'тестовые:', isMockData);
  ...
  const stats = [
    { label: 'Цена на товар не соответствует', value: data.paid, status: 'paid', color: config.colors.paid },
  ];
