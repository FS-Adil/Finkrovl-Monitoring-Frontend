...
function OrderPmoOne ({ widgetId, data, loading, isMockData }) {
  const [selectedStatus, setSelectedStatus] = useState(null);
  const [modalOpen, setModalOpen] = useState(false);

  console.log(`[OrderPmoOne] Рендер виджета ${widgetId}, данные:`, data ? 'есть' : 'нет', 'тестовые:', isMockData);
  ...
  const stats = [
    { label: 'Нет приходной накладной', value: data.paid, status: 'paid', color: config.colors.paid },
